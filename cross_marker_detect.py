...
class subcomim:
    def __init__(self):
        ...
        self.subscriber = rospy.Subscriber('/dok3/flow_cam/image_raw/compressed', CompressedImage, self.callback, queue_size=1)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for pts in contours:
            ...
            #12각형 -> 십자 마크
            if vtc == 12:
                image.setLabel(image.image_np,pts,'+MARKER')
                # thresh
                # setLabel(thresh,pts,'+MARK0ER')
                print('+marker detected')
